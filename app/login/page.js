        ...
        <>
            <div className="flex flex-col items-center min-h-[90%] w-[33%] space-y-4 m-auto text-center text-gray-300 rounded-lg pt-15 mt-5 font-bold">
                ...
                <p className="text-5xs">
                    Join our academic community to ask questions, answer others' queries, earn points and badges through gamification, and share helpful notes on various topics for fellow learners.
                </p>
